...
Parcel is a conversion-focused full-site-editing theme for direct-to-consumer brands that ship. Named for the package on the doorstep — the promise kept.

Features an unboxing hero section, product-feature patterns, a subscription pricing tier, and a WooCommerce-compatible layout system. Syne headlines and Outfit body text create a warm, contemporary brand voice. WCAG 2.2 AA accessible, Core Web Vitals optimised, self-hosted SIL OFL fonts, RTL-ready via CSS logical properties, zero plugin dependencies.
