...
PAGES = [
    ...
    ("02-product.html",          1440, 900,  "02-product.png",                True),
    ("03-shop.html",             1280, 900,  "03-shop.png",                   True),
    ("04-about.html",            1200, 900,  "04-about.png",                  True),
    ("05-pricing.html",          1200, 900,  "05-pricing.png",                True),
    ("06-post.html",             1200, 900,  "06-post.png",                   True),
    # Mobile viewports
    ("07-front-mobile.html",      375, 812,  "07-front-mobile-375.png",       True),
    ("08-product-mobile.html",    390, 844,  "08-product-mobile-390.png",     True),
    # Color variants — show palette flexibility
    ("09-carbon.html",           1200, 900,  "09-carbon-variant.png",         True),
    ("10-sage.html",             1200, 900,  "10-sage-variant.png",           True),
]
