...
function setup(): void {
	...
	// i18n. The domain is the literal 'parcel' (a constant would break make-pot —
 ...
 *
 * Parcel is not a shop design, but "not a shop design" must never mean "broken
...
function skip_link(): void {
	echo '<a class="skip-link" href="#main-content">'
		. esc_html__( 'Skip to content', 'parcel' )
		. '</a>';
}
