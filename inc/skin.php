...
function parcel_skin_pattern_categories(): void {
	register_block_pattern_category(
		PARCEL_SLUG . '-sections',
		array(
			'label'       => __( 'Parcel: Sections', 'parcel' ),
			'description' => __( 'Section patterns for building pages.', 'parcel' ),
		)
	);
 ...
 */
add_filter( PARCEL_SLUG . '/preload_fonts', static function ( array $fonts ): array {
