 ...
 * the skin (Parcel's personality). Each sheet depends on the previous so the
 ...
 * the parcel/preload_fonts filter (registered in inc/skin.php).
 *
...
function enqueue_assets(): void {
	...
	$sheets = array(
		...
		'skin'  => 'assets/css/skin.css',       // [SKIN] Parcel's layout, components, blocks, utilities.
	);
 ...
 * inc/skin.php adds Syne (the h1/display font) via this filter.
 *
...
function preload_fonts(): void {
	 ...
	 */
	$fonts = (array) apply_filters( 'parcel/preload_fonts', array() );
