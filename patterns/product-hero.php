 ...
 *
 * Heading note: this pattern supplies the front page's single h1 (the headline
 * below). front-page.html has no heading block of its own and relies on this
 * pattern for its h1; keep exactly one h1 here.
 *
 * @package parcel
 */
?>
...
<div class="wp-block-group parcel-pattern-product-hero parcel-hero" style="background-color:var(--wp--preset--color--parcel-cream);min-height:90dvh">
	...
	<div class="wp-block-columns" style="gap:0;padding:0">
		...
		<div class="wp-block-column" style="flex-basis:55%">
			...
			<!-- wp:paragraph {"className":"is-style-parcel-eyebrow","style":{"typography":{"fontFamily":"var:preset|font-family|outfit","fontSize":"0.6875rem","fontWeight":"700","letterSpacing":"0.12em","textTransform":"uppercase"},"color":{"text":"var:preset|color|parcel-rust"},"spacing":{"margin":{"bottom":"var:preset|spacing|4"}}}} -->
			<p class="is-style-parcel-eyebrow" style="color:var(--wp--preset--color--parcel-rust)">Curated Monthly</p>
			<!-- /wp:paragraph -->
			...
			<div class="wp-block-buttons">
				...
				<div class="wp-block-button">
					<a class="wp-block-button__link wp-element-button" href="/subscribe" style="background-color:var(--wp--preset--color--parcel-orange);color:var(--wp--preset--color--parcel-ink)">Start your subscription</a>
				</div>
				<!-- /wp:button -->
