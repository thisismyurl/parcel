<?php
/**
 * Parcel — theme entry point (thin loader, nothing more).
 *
 ...
 * is inc/bootstrap.php (the namespace + the PARCEL_SLUG/PARCEL_VERSION constants).
 *
 * [CORE] This is the portable loader. The `parcel` CLI rewrites the namespace
 * and slug on the way into each theme it generates, so a shipped theme's
 * functions.php is byte-for-byte this file with `Parcel`/`parcel` swapped
